...
INSERT INTO employee (Name, Gender, Employee_type, Date_of_birth, Notice_period, Salary) 
VALUES ('Abhishek Kute', 'Male', 'HR', '2005-03-02', FALSE, 1000000);
select * from employee 

Here are 29 sample INSERT statements for your employee table, using realistic varied data across genders, types, birth dates (2000s for young professionals), notice periods, and salaries.
...
INSERT INTO employee (Name, Gender, Employee_type, Date_of_birth, Notice_period, Salary) VALUES
('Auuj Sharma', 'Female', 'Intern', '2004-07-15', FALSE, 50000)
select * from employee 


Alter table employee add column phone_no VARCHAR(10) Not NUll ;
select * from employee
alter table employee modify column phone_no VARCHAR(20) ;
alter table employee rename column phone_no to Phone
